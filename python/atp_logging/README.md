...
| `IB_GATEWAY` | `CONNECT`, `DISCONNECT`, `RECONNECT`, `HEARTBEAT_STALE`, `HEARTBEAT_RECOVERED` |
| `KILL_SWITCH` | `ACTIVATION` |
| `HOT_SWAP` | `PROMOTION`, `DEMOTION` |
| `RESOURCE_MONITOR` | `THRESHOLD_ALERT` |
| `MARKET_DATA` | `SUBSCRIPTION_CHANGE`, `SEQUENCE_GAP`, `HEARTBEAT_STALE`, `HEARTBEAT_RECOVERED` |
