...
| TBD-15 | Should future revisions support separate configurable windows for Reservoir ranking and momentum scoring? The current baseline uses a single configurable evaluation window with a default of 30 days for both. | Potential future enhancement to SYS-48 and SYS-49a. | Stakeholder | Open |
