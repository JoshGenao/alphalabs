...
block was re-run at the commit this document ships with (`7871991`). It is a
...
The judgment critic sits at **`block` after 20 rounds**. This feature integrated
...
$ git rev-parse HEAD
78719914b942f4acd5a7085f8d9832917e467544
[exit 0]
...
deterministic critic: approve @ 78719914
judgment critic    : block | rounds: 20 | reviewer: claude-fallback
[exit 0]
...
$ gh run list --commit 78719914b942f4acd5a7085f8d9832917e467544 --json workflowName,conclusion,headSha --jq '.[] | "\(.conclusion)	\(.workflowName)"'
	ci
success	security
skipped	integration
[exit 0]
...
119 passed, 9 subtests passed in 120.07s (0:02:00)
[exit 0]
