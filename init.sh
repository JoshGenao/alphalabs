...
export ATP_IB_RESTART_ET="${ATP_IB_RESTART_ET:-23:45}"
export ATP_IB_RESTART_WINDOW_SECONDS="${ATP_IB_RESTART_WINDOW_SECONDS:-300}"
export ATP_IB_RESTART_SUSPEND_LEAD_SECONDS="${ATP_IB_RESTART_SUSPEND_LEAD_SECONDS:-60}"
