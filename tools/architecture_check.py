...
def assert_store_history(config: dict) -> list[str]:
    ...
    summary = (
        ...
        "(tests/domain/test_store_history_consumer.py); the FACTOR-JOB consumer now READS the store "
        "(atp-factor-pipeline store_inputs loaders + assemble_factor_inputs, a point-in-time read primitive; "
        ...
        "real-calendar mapping is deferred, see SRS-FAC-001); deferred -- the Jupyter notebook HOST runtime (SRS-RES-002); "
